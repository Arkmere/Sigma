...
33. Ticket 6E anatomy: a typed static registry maps canonical physical facts to controlled model, region, orientation, anchor and overlay metadata. One repository-owned SVG symbol family is copied into the offline build and composed with semantic inline overlays. This is not persistence, migration, conversion, import or authorization data; Ticket 6F navigation remains deferred.
