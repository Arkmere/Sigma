...
- Neutral, Masculine and Feminine share an 18-view standalone V1 vocabulary. Twenty-six of the 35 guided facts now have standalone three-family coverage: the accepted twelve plus Back width, Torso length, Arm length, Upper-arm circumference, Forearm circumference, Outseam, Front rise, Back rise, Thigh circumference, Knee circumference, Calf circumference, Ankle circumference, Arch length and Instep circumference.
- Nine intentional gaps remain on the transitional Neutral prototype: Weight, Wrist circumference, Hand length, Hand width, Palm circumference, Finger circumference, Foot length, Foot width and Foot circumference. Completing them requires specialised scales, palm/hand detail, finger detail and top/dorsal-foot views rather than more coordinates on the current artwork.
