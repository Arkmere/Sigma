...
export const permissionExplanations: Record<PermissionKind, PermissionExplanation> = {
  ...
  camera: { kind:'camera', title:'Measure with camera', requestedAccess:'Camera access for a focused future measurement', reason:'To capture one specific measurement after your direction.', willAccess:['A deliberate future capture'], willNotAccess:['Your photo library','Background camera access'], alternatives:['Enter the measurement manually'], denialEffect:'Manual measurements remain fully usable.' },
  ...
  nearby_devices: { kind:'nearby_devices', title:'Connect measurement device', requestedAccess:'A future nearby measurement device', reason:'To receive measurements from a device you deliberately connect.', willAccess:['Measurements supported by the selected device'], willNotAccess:['Unrelated nearby devices','Background discovery'], alternatives:['Enter measurements manually'], denialEffect:'Existing records and manual entry are unaffected.' },
  files: { kind:'files', title:'Choose scan file', requestedAccess:'One deliberately selected future scan file', reason:'To preview allowlisted measurements from that file.', willAccess:['Only the file you select'], willNotAccess:['Other files or folders'], alternatives:['Enter measurements manually'], denialEffect:'No file is read and manual entry remains available.' },
};
