...
test('schema 2 migrates to schema 4 and malformed correction metadata fails closed',()=>{
  ...
  assert.equal(migrated.status,'ok');assert.equal(migrated.data.schemaVersion,4);
