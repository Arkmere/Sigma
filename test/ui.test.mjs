...
test('shell renders truthful empty states and switches every primary route without crashing', () => {
  ...
  for (const [route, expected] of [['profiles', /Profiles/], ['measurements', /Create a profile before adding records/], ['family', /Family workflows are locked/], ['sources', /Nothing enters Sigma merely because/], ['privacy', /Who can see profiles/], ['settings', /Family entitlement/]]) {
